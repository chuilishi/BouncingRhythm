...
namespace RhythmTool
{
    ...
    {        
        ...
        public static readonly GUIContent saveButton = EditorGUIUtility.IconContent("SaveActive");
        ...
        public static Dictionary<KeyType, Color> keyTocolors = new Dictionary<KeyType, Color>
        {
            {KeyType.LeftSingle, Color.cyan},
            {KeyType.LeftDouble, Color.green},
            {KeyType.RightSingle ,Color.red},
            {KeyType.RightDouble, Color.magenta},
            {KeyType.LeftSimultaneous, Color.black },
            {KeyType.RightSimultaneous, Color.grey},
        };
        ...
        static Styles()
        {
            ...
            // feature.normal.background = Resources.Load<Texture2D>("SinglePixel/WhiteSinglePixel");
            feature.normal.background = TextureFactory.GetTexture(Color.white);
            // feature.active.background = Resources.Load<Texture2D>("SinglePixel/SelectedFeature_Blue");
            feature.active.background = TextureFactory.GetTexture(Color.blue);

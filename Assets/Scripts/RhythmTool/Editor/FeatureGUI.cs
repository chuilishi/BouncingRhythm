...
namespace RhythmTool
{
    ...
    public class FeatureGUI<T> : FeatureGUI where T : Feature
    {
        ...
        {
            // FIXED
            feature.timestamp = Aligner.Instance.Align(timestamp + delta.x / state.pixelsPerSecond,out int beatCount);
            feature.key.beat = beatCount;
            // feature.key.UpdateTime();
        }
        ...
        protected virtual void Draw(EditorState state)
        {
            ...
            //TODO
            // Styles.feature.normal.background = TextureFactory.GetTexture(Styles.keyTocolors[feature.chart.keys[feature.keyIndex].keyType]);
            Styles.feature.normal.background = TextureFactory.GetTexture(Styles.keyTocolors[feature.key.keyType]);
